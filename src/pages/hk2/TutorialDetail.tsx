...
const TutorialDetailHK2: React.FC = () => {
  ...
  const gamePrefix = '/hk2';
  const tutorial = tutorialsHK2.find(t => t.id === id);
            ...
            <div className="space-y-6">
              <div className="bg-hollow-dark rounded-lg p-6">
                ...
                <p className="text-gray-300">
                  Excelente checklist! Está me ajudando muito a rastrear todos os fragmentos de carretel. 
            ...
            {tutorialsHK2
              ...
              .map((relatedTutorial) => (
                <Link
                  ...
                  to={`${gamePrefix}/tutorial/${relatedTutorial.id}`}
                  className="bg-hollow-darker rounded-lg p-6 hover:bg-gray-800 transition-colors duration-200"
                >
                  <h4 className="text-lg font-semibold text-white mb-2 hover:text-blue-400 transition-colors duration-200">
...
export default TutorialDetailHK2;
